...
export default function Experience() {
  return (
    ...
    >
      <div className="reveal" style={{ ...MONO, fontSize: "13px", color: "#d4ff3d", letterSpacing: "2px", marginBottom: "38px" }}>
        01 / EXPERIENCE
      </div>
          ...
          >
            ...
            <div>
              <div style={{ display: "flex", alignItems: "baseline", gap: "12px", flexWrap: "wrap", marginBottom: "8px" }}>
                ...
                <span style={{ fontSize: "15px", color: "#d4ff3d" }}>{exp.org}</span>
              ...
              <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: "9px" }}>
                {exp.bullets.map(b => (
                  <li key={b} style={{ display: "flex", gap: "10px", fontSize: "15px", color: "#aab0b6", lineHeight: "1.55" }}>
                    <span style={{ color: "#d4ff3d", flexShrink: 0 }}>▹</span>
                    {b}
                  </li>
                ))}
              </ul>
