  ...
  return (
    ...
    >
      ...
      <a
        ...
        rel="noopener noreferrer"
        style={{
          display: "block", textDecoration: "none", marginTop: "32px",
          background: "linear-gradient(155deg, rgba(22,26,29,0.92), rgba(12,15,17,0.85))",
          border: "1px solid rgba(255,255,255,0.09)",
          borderRadius: "22px", overflow: "hidden",
          willChange: "transform", transition: "transform .18s ease-out",
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1.2fr 1fr" }}>
          ...
          <div style={{ padding: "44px 46px" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "18px" }}>
              <span style={{
                width: "38px", height: "38px", borderRadius: "10px",
                background: "rgba(37,99,235,0.16)", border: "1px solid rgba(37,99,235,0.4)",
                display: "flex", alignItems: "center", justifyContent: "center",
                color: "#2563eb", fontWeight: 700, ...MONO,
              }}>J</span>
              <span style={{ ...MONO, fontSize: "12px", color: "#6f757b" }}>Solo project</span>
            </div>

            <h3 style={{ fontSize: "34px", fontWeight: 600, letterSpacing: "-0.8px", color: "#f3f5f6", margin: "0 0 12px" }}>Job Tracker</h3>
            <p style={{ fontSize: "16px", lineHeight: "1.6", color: "#aab0b6", margin: "0 0 24px", maxWidth: "440px" }}>
              A full-stack job application tracker with a FastAPI backend, React dashboard, and Neon-hosted PostgreSQL database, deployed on Railway and Vercel with multi-user JWT authentication.
            </p>

            <ul style={{ listStyle: "none", padding: 0, margin: "0 0 28px", display: "flex", flexDirection: "column", gap: "11px" }}>
              {[
                "Multi-user JWT authentication with bcrypt password hashing",
                "Relational schema with an append-only status history event log, powering four analytics endpoints",
                "Dockerized dev environment with Alembic-managed schema versioning, separate from the Neon production database",
              ].map(item => (
                <li key={item} style={{ display: "flex", gap: "10px", fontSize: "15px", color: "#c2c7cc", lineHeight: "1.5" }}>
            ...
            <div style={{ display: "flex", flexWrap: "wrap", gap: "8px", marginBottom: "26px" }}>
              {[["Python","37,99,235"],["FastAPI","16,185,129"],["PostgreSQL","56,189,248"],["Docker","37,99,235"],["JWT","139,92,246"]].map(([s,c]) => (
                <span key={s} className="sk" style={{ "--c": c } as React.CSSProperties}>{s}</span>
              ))}
            </div>
            ...
            <span className="mag" style={{
              display: "inline-flex", alignItems: "center", gap: "8px",
              ...MONO, fontSize: "13px", fontWeight: 600,
              color: "#0a1330", background: "#2563eb",
              padding: "12px 20px", borderRadius: "9px", willChange: "transform",
            }}>
              visit live site →
            </span>
          ...
          <div style={{
            position: "relative",
            background: "radial-gradient(120% 100% at 80% 0%, rgba(37,99,235,0.18), transparent 60%)",
            borderLeft: "1px solid rgba(255,255,255,0.06)",
            display: "flex", alignItems: "center", justifyContent: "center",
            padding: "30px", minHeight: "320px",
          }}>
